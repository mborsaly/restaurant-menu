export const t = (key, lang = 'en') => {
  const translations = {
    ...
    'cart_empty_sub': {
      ...
      fr: 'Ajoutez des articles du menu pour commencer',
    },
    'browse_menu': {
      en: 'Browse Menu',
      fr: 'Voir le menu',
    ...
    'terms': {
      en: 'By ordering you agree to our terms of service',
    ...
    'check_whatsapp_desktop': {
      en: '📱 Check your WhatsApp for order confirmation',
    ...
    'link_expired_sub': {
      en: 'Please call us again to receive a fresh menu link.',
      fr: 'Veuillez nous rappeler pour recevoir un nouveau lien.',
    },
    'open_until': {
      en: 'Open until',
      fr: "Ouvert jusqu'à",
