...
export default function ItemSheet({
  ...
  const unitLabel =
    (UNIT_LABELS[unit] || UNIT_LABELS.piece)[lang] ||
    (UNIT_LABELS[unit] || UNIT_LABELS.piece).en
      ...
      <div style={{
        ...
        {isGrocery && fullItem.stock_qty != null && (
          <p style={{
            ...
            {lang === 'ar'
              ? `متوفر: ${fullItem.stock_qty} ${unitLabel}`
              : lang === 'fr'
                ? `En stock: ${fullItem.stock_qty} ${unitLabel}`
      ...
      {loading ? (
        ...
        <>
          ...
          <div style={{
            ...
            // Keep the outer layout stable.
            // The order of the label and stepper is
            ...
            <div style={{
              ...
              // Arabic: stepper on the LEFT
              // LTR: stepper on the RIGHT
              order: rtl ? 1 : 2,
